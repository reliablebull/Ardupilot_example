...
# message interval command

set_message_interval_command = dialect.MAVLink_command_long_message(
...
while True:
    message = vehicle.recv_match(type=dialect.MAVLink_extended_sys_state_message.msgname , blocking=True)
